...
* Focusing on what is best not just for us as individuals, but for the overall
  community
* Assuming that someone reporting a problem on unfamiliar hardware, an old R
  version, or a constrained network is describing a real problem worth
  understanding
...
address listed in `DESCRIPTION`. All complaints will be reviewed and
